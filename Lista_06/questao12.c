...
int main (){
    ...
    tRGB maior, menor;
    maior = pixelRGBMax (imagem);
    printf("Maior pixel da imagem: \nR: %d\nG: %d\nB: %d\n", maior.R, maior.G, maior.B);
    menor = pixelRGBMin (imagem);
    printf("Menor pixel da imagem: \nR: %d\nG: %d\nB: %d\n", menor.R, menor.G, menor.B);
